...
<!-- Mirrored from bucketadmin.lab.themebucket.net/mail_view.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 13:24:38 GMT -->
<head>
    <meta charset="utf-8">
...
<li><a href="typography.html">Typography</a></li>
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="mail_view.html">View Mail</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
