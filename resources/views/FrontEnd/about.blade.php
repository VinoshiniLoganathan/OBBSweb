...
<!-- Mirrored from demo.artureanec.com/html/helpo/mono/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 15:35:24 GMT -->
						...
						<div class="col-auto">
							...
							<nav>
								<ul class="main-menu">
									...
									<li class="main-menu__item main-menu__item--has-child main-menu__item--active"><a class="main-menu__link" href="/about"><span>About Us</span></a>
										<!-- sub menu start-->
					...
					<div class="promo-slider">
						<div class="promo-slider__item promo-slider__item--style-1">
							...
							<div class="align-container__item"><span class="promo-primary__pre-title"></span>
								<h1 class="promo-primary__title"><br><span>About Us</span>
							</div>
							<div class="container">
								<div class="row">
									<div class="col-12">
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-xl-6 offset-xl-1">
								<div class="heading heading--primary"><span class="heading__pre-title"></span>
									<h2 class="heading__title"><span>About Us</span> </h2>
								</div>
								<p><strong>Every Drops Count!</strong></p>
								<p>For the hospital management support, this website focuses on collecting blood bags counts and information from all hospitals in Selangor state. This could provide some help in keeping tracks of the blood bags counts all the time. Blood donation campaigns from various hospitals are also stored here to avoid clashes of schedule between the hospitals. Besides, hospitals can promote each other donation campaigns more efficiently. </p>
								<p>From the donors' perspectives, this website would assist them in following up their blood donation activities. Donors could also get updates about campaigns and proceed with the registration process using this website with a single click. Donors can look up for the benefits that they could gain from their donations.</p>
							</div>
						</div>
					</div>
				</section>
...
<!-- Mirrored from demo.artureanec.com/html/helpo/mono/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 15:35:26 GMT -->
</html>