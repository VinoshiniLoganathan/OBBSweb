                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal" action="/dnr_newprof/<?php echo $upd[0]->id; ?>" method="GET">
                                {{-- {{ url()->previous() }} --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="" id="address" name="address" value = '<?php echo$upd[0]->address?>' class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" readonly="readonly" placeholder="" id="bloodgroup" name="bloodgroup" value = '<?php echo$upd[0]->bloodgroup?>' class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Blood Rh</label>
                                    <div class="col-lg-6">
                                        <input type="text" readonly="readonly" placeholder="" id="bloodRh" name="bloodRh" value = '<?php echo$upd[0]->bloodRh?>' class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Email Address</label>
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="" id="email" name="email" class="form-control" value='<?php echo$upd[0]->email?>'/>
                                    </div>
                                </div>
                                <div class="form-group">
