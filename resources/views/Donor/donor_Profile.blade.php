...
<!-- Mirrored from bucketadmin.lab.themebucket.net/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 13:24:52 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="recent-act">
                                            ...
                                            <div class="activity-desk">
                                                <h2 class="purple">Blood Group</h2>
                                                <p>{{ $views->bloodgroup }}</p>
                                            </div>

                                            <div class="activity-desk">
                                                <h2 class="purple">Blood Rh</h2>
                                                <p>{{ $views->bloodRh }}</p>
                                            </div>
                                        ...
                                        <div class="form">
                                            <form class="cmxform form-horizontal"  method="GET" action="dnr_update/{{ $views->id }}">
                                                <div class="clearfix">
...
<!-- Mirrored from bucketadmin.lab.themebucket.net/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 13:24:54 GMT -->
</html>
